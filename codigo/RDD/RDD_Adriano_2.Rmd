...
RDD(df_rdd_sinan, x = val_margem_vitoria_feminina, y = y_sinan_agressao_ameaca)


g <- rdplot(
  y = df_rdd_sinan$y_sinan_agressao_ameaca,
  ...
  nbins = 100,
  p = 4,
  title = "Ameaça Contra Mulheres",
  y.label = "Notificações Sinan / 100k H.",
...
ggsave(
  filename = "../../Graficos/grafico_rdd_ameaca.pdf",
  plot = g$rdplot,
